...
function Register()
{
    ...
    const insert=()=>
    {
        ...
        setMessage("First Name or Last Name is required, It cannot be empty");
        else if(registerData.mobile.length<10 || registerData.mobile.length>10)
        setMessage("Enter Valid Mobile Number");
        else if(!registerData.email.match(/^[a-zA-Z0-9]+@+[a-zA-Z0-9]+.+[A-z]/))
                     ...
                     <input type="text"
                        ...
                        onChange={OnTextChange} />
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" placeholder="Enter LastName" value={registerData.last_name} name="last_name" onChange={OnTextChange} required={true}></input>
                                </td>
                            </tr>
                            <tr>
                                <td>Email</td>
                                <td>
                                    <input type="text" placeholder="Enter Email" value={registerData.email} name="email" onChange={OnTextChange} required={true} ></input>
                                </td>
                            </tr>
                            <tr>
                                <td>Password</td>
                            ...
                            name='password'
                            onChange={OnTextChange} required={true}
                            />
                                </td>
                            </tr>
                            <tr>
                                <td>Mobile:</td>
                                <td>
                                    <input type="text" placeholder="Enter Mobile Number" value={registerData.mobile} name='mobile' onChange={OnTextChange} maxLength={10} required={true} ></input>
                                </td>
                            </tr>
                            <tr>
                                <td colSpan={"4"}>
