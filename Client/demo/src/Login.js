...
function Login()
{
        ...
        helper.onreadystatechange=()=>
        {
            if(helper.readyState==4 && helper.status==200)
            {
                ...
                if(responeReceived.isvalid!='false')
                {
                    ...
                    sessionStorage.setItem("firstName",responeReceived.firstName);
                    sessionStorage.setItem("lastName",responeReceived.lastName);
    ...
    return (
        ...
        <br/>
                <center>
                    <h1 className='heading'> PLEASE LOG IN TO CONTINUE...</h1>
                    <hr></hr>
